 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Mon Aug 19 13:42:54 2019
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME selectHexOutTemp
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
extern void selectHexOutTemp_Outputs_wrapper(const real_T *u0,
			real_T *y0);
/*====================*
 * S-function methods *
 *====================*/
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    selectHexOutTemp_Outputs_wrapper(u0, y0);
