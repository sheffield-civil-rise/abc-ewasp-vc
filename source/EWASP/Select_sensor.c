 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Wed Mar 18 10:35:59 2020
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME Select_sensor
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
extern void Select_sensor_Outputs_wrapper(const real_T *u0,
			real_T *y0);
/*====================*
 * S-function methods *
 *====================*/
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    Select_sensor_Outputs_wrapper(u0, y0);
