function [room2roomflowmatrix_N,room2roomflowmatrix_E,room2roomflowmatrix_S,room2roomflowmatrix_W,StateAirInEXPANDED_N,StateAirInEXPANDED_E,StateAirInEXPANDED_S,StateAirInEXPANDED_W,StateAirOutEXPANDED_N,StateAirOutEXPANDED_E,StateAirOutEXPANDED_S,StateAirOutEXPANDED_W,deltaPEXPANDED_N,deltaPEXPANDED_E,deltaPEXPANDED_S,deltaPEXPANDED_W,HCM,HCM_closed,VCM,numRooms]=Airflow_State_Model_PassiveMech(HCM,HCM_closed,verticalConnectMatrix,NESW_Lengths,upDown,ACR,rotation,flip,bungalow,state,ExtractRates)

numRooms=nnz(sum(HCM+HCM_closed,1));%determines how may pressure variables to use
...
InDensityLookUp=[1.291, 1.291, 1.291];%densities are fixed at 0 in out difference to elimate consideration of stack effect
InTemp=[0, 0, 0]; %actually represents difference between inside and outside temps
...
[out]=vpasolve(f(1:numRooms)+ExtractRates(:,o)==zeros(numRooms,1),PR(1:numRooms,1)); %Solve all of the flow equations
