 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Tue Mar 16 13:33:53 2021
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME Select_sensor_bot
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
extern void Select_sensor_bot_Outputs_wrapper(const real_T *u0,
			real_T *y0);
/*====================*
 * S-function methods *
 *====================*/
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    Select_sensor_bot_Outputs_wrapper(u0, y0);
