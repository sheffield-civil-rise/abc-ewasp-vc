 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Tue Jul 23 14:01:49 2019
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME Select_sensor_mid
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
extern void Select_sensor_mid_Outputs_wrapper(const real_T *u0,
			real_T *y0);
/*====================*
 * S-function methods *
 *====================*/
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    Select_sensor_mid_Outputs_wrapper(u0, y0);
