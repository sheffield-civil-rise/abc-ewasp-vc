function [room2roomflowmatrix_N,room2roomflowmatrix_E,room2roomflowmatrix_S,room2roomflowmatrix_W,StateAirInEXPANDED_N,StateAirInEXPANDED_E,StateAirInEXPANDED_S,StateAirInEXPANDED_W,StateAirOutEXPANDED_N,StateAirOutEXPANDED_E,StateAirOutEXPANDED_S,StateAirOutEXPANDED_W,deltaPEXPANDED_N,deltaPEXPANDED_E,deltaPEXPANDED_S,deltaPEXPANDED_W,HCM,HCM_closed,VCM,numRooms]=Airflow_State_Model(C_d,HCM,HCM_closed,verticalConnectMatrix,NESW_Lengths,upDown,ACR,rotation,flip,bungalow,state)

numRooms=find(sum(HCM+HCM_closed,1),1,'last');%determines how may pressure variables to use
...
room2roomflowmatrix{i,o}=double(1.5*(1.3*nthroot(2*(PR-PN).^3,5)).*HCM+ClosedTGrad.*nthroot((PR-PN).^3,5)+InDensityLookUp(1,o)*C_d*(1.3*nthroot(1.63*((PR-PN)-2.8*InDensityLookUp(1,o)*9.81.*VCM).^3,5)).*abs(VCM)); %openFlows+closedFlows+VerticalFlows
